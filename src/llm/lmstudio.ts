...
function systemPrompt(current: Config): string {
  return [
    ...
    '',
    '  For a PURE STYLE change (just color/size/weight/etc), DO NOT include slots in the patch.',
    '  Slot content is preserved automatically when you omit it. Touching slots.{name} alongside a',
    '  style change is almost always wrong and produces invalid output.',
    '',
